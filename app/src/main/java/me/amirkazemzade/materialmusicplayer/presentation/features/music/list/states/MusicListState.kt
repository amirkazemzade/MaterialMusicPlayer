package me.amirkazemzade.materialmusicplayer.presentation.features.music.list.states
...
sealed class MusicListState(open val sortType: DefaultSortType, open val sortOrder: SortOrder) {
    data class Loading(
        override val sortType: DefaultSortType = DefaultSortType.DATE_ADDED,
